...
/**
 * src/Shared/Submodule/EReferral/Service/EReferralService.php
 *
...
final class EReferralService
{
    ...
    /**
     * Build a plain-text medication list from active MAR orders for this episode.
     * Returns empty string if no orders exist (caller leaves field blank).
     */
    ...
    /**
     * Fetch documented allergies from the OpenEMR lists table.
     * Returns a plain-text list, or empty string if none recorded.
     */
