...
--
-- Host: localhost
-- Generation Time: Feb 28, 2026 at 07:52 PM
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='ADL charting sessions; one row per aide session covering all 7 domains';

--
-- Dumping data for table `oei_adl_record`
--

INSERT INTO `oei_adl_record` (`id`, `episode_id`, `facility_id`, `noted_by_user_id`, `noted_datetime`, `adl_json`, `adl_score`, `notes`) VALUES
(1, 14, 1, 1, '2026-02-27 16:20:13', '{\"bathing\":4,\"dressing\":3,\"grooming\":3,\"transfer\":3,\"ambulation\":3,\"eating\":2,\"toileting\":4}', 22, 'Night shift: confused, resisted morning care. Bed alarm triggered twice. No fall.'),
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Per-user alert snooze/acknowledgement records';

--
-- Dumping data for table `oei_alert_ack`
--

INSERT INTO `oei_alert_ack` (`id`, `alert_key`, `facility_id`, `user_id`, `acked_datetime`, `expires_datetime`) VALUES
(1, 'LWBS_RISK:6', 1, 1, '2026-02-28 20:20:11', '2026-02-28 23:20:11'),
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AL-specific overlay on oei_episode; links to form_encounter for care plan anchoring';

--
-- Dumping data for table `oei_al_episode`
--

INSERT INTO `oei_al_episode` (`id`, `episode_id`, `pid`, `facility_id`, `encounter_id`, `room`, `unit`, `care_level`, `fall_risk_level`, `fall_risk_score`, `admit_reason`, `last_adl_score`, `last_adl_datetime`, `created_datetime`) VALUES
(1, 14, 50, 1, 297, '101', 'Wing A', 'TIER_3', 'HIGH', 78, 'Memory care — moderate dementia with behavioral disturbances and fall history', 14, '2026-02-28 16:20:13', '2026-01-12 22:20:13'),
...
INSERT INTO `oei_bh_boarding` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `legal_status`, `suicide_risk`, `violence_risk`, `placement_status`, `accepting_facility`, `accepted_datetime`, `transport_method`, `transport_datetime`, `emtala_complete`, `checklist_json`, `notes`, `updated_by_user_id`, `updated_datetime`) VALUES
(1, 6, 4, NULL, 1, 'VOLUNTARY', 'HIGH', 'LOW', 'SEARCHING', NULL, NULL, NULL, NULL, 1, '{\"items\":[{\"label\":\"EMTALA MSE completed\",\"done\":true},{\"label\":\"Insurance verified — MediCal\",\"done\":true},{\"label\":\"Placement calls initiated\",\"done\":true},{\"label\":\"Accepting facility confirmed\",\"done\":false},{\"label\":\"Family notified\",\"done\":true},{\"label\":\"Transport arranged\",\"done\":false}]}', 'Called Valley BH (full), State Hospital (waitlist — ETA 6-8h), Riverside BH (no voluntary beds). Re-calling Valley BH at next hour.', 1, '2026-02-28 20:20:11'),
(2, 13, 11, NULL, 1, 'VOLUNTARY', 'MODERATE', 'LOW', 'ACCEPTED', 'Valley Behavioral Health Center', NULL, NULL, NULL, 1, '{\"items\":[{\"label\":\"EMTALA MSE completed\",\"done\":true},{\"label\":\"Insurance verified — Blue Shield\",\"done\":true},{\"label\":\"Placement calls initiated\",\"done\":true},{\"label\":\"Accepting facility confirmed\",\"done\":true},{\"label\":\"Family notified\",\"done\":true},{\"label\":\"Transfer paperwork complete\",\"done\":true},{\"label\":\"Transport arranged\",\"done\":true}]}', 'Valley BH accepted at 0930. Transport: Medvan unit dispatched, ETA 30-45 min. Patient and family updated and relieved.', 1, '2026-02-28 20:50:12');
...
INSERT INTO `oei_bh_safety` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `observation_level`, `is_involuntary`, `risk_violence`, `risk_suicide`, `elopement_risk`, `precautions_json`, `updated_by_user_id`, `updated_datetime`) VALUES
(1, 6, 4, NULL, 1, '1:1', 0, 0, 1, 1, '{\"items\":[\"Sharps removed from room and patient\",\"Street clothing searched\",\"Belts and shoelaces removed\",\"1:1 sitter assigned — shift change at 1500\",\"Columbia Suicide Severity Rating Scale completed: High risk\",\"Crisis counselor notified\"]}', 1, '2026-02-28 17:30:11'),
(2, 12, 10, NULL, 1, '1:1', 0, 1, 0, 1, '{\"items\":[\"Wrist restraints applied — combative on arrival\",\"Belongings searched — no sharps found\",\"1:1 nurse monitoring for re-sedation\",\"Elopement risk — patient attempted to leave x1\",\"IV secured with armboard\"]}', 1, '2026-02-28 21:05:12'),
(3, 13, 11, NULL, 1, 'Q15', 0, 0, 1, 0, '{\"items\":[\"Voluntary patient — fully cooperative\",\"Belongings searched — no contraband\",\"Q15-minute safety checks\",\"Family at bedside\",\"Columbia SSRS: moderate risk\",\"Crisis counselor evaluation completed\"]}', 1, '2026-02-28 14:40:12');
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Current diversion status per facility and service line';

--
-- Dumping data for table `oei_diversion`
--

INSERT INTO `oei_diversion` (`id`, `facility_id`, `service_line`, `status`, `reason`, `diversion_start`, `diversion_end`, `updated_by_user_id`, `updated_datetime`) VALUES
(1, 1, 'TRAUMA', 'DIVERSION', 'Mass casualty incident diverted — both trauma bays occupied. Redirect all trauma activations to Regional Trauma Center.', '2026-02-28 20:20:10', NULL, 1, '2026-02-28 20:20:10'),
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Audit log of all diversion status changes';

--
-- Dumping data for table `oei_diversion_history`
--

INSERT INTO `oei_diversion_history` (`id`, `facility_id`, `service_line`, `previous_status`, `new_status`, `reason`, `diversion_start`, `diversion_end`, `changed_by_user_id`, `changed_datetime`) VALUES
(1, 1, 'TRAUMA', 'OPEN', 'DIVERSION', 'Mass casualty incident — both bays activated', NULL, NULL, 1, '2026-02-28 20:19:41'),
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Offline write queue — rows written by browser during network outage';

--
-- Dumping data for table `oei_downtime_sync_queue`
--

INSERT INTO `oei_downtime_sync_queue` (`id`, `facility_id`, `entry_type`, `payload_json`, `captured_client`, `queued_datetime`, `synced_datetime`, `status`, `result_note`, `submitted_by_user_id`) VALUES
(1, 1, 'ARRIVAL', '{\"fname\": \"Carlos\", \"lname\": \"Mendez\", \"dob\": \"1985-06-14\", \"chief_complaint\": \"Chest pain, onset 30 min ago\", \"arrival_mode\": \"WALKIN\", \"acuity_esi\": 2}', '2026-02-28 20:52:12', '2026-02-28 21:00:12', '2026-02-28 21:02:12', 'SYNCED', 'Synced — episode created pid 12', 1),
...
INSERT INTO `oei_episode` (`id`, `pid`, `eid`, `facility_id`, `type`, `start_datetime`, `end_datetime`, `disposition`, `status`, `chief_complaint`, `acuity_esi`, `provider_user_id`, `triage_completed_datetime`, `last_status_update`, `arrival_mode`, `triage_datetime`, `triage_note`, `created_by_user_id`, `created_datetime`, `assigned_nurse_user_id`, `assigned_provider_user_id`) VALUES
(1, 2, NULL, 1, 'ED', '2026-02-28 19:19:41', NULL, NULL, 'ACTIVE', 'Altered mental status, fever, productive cough', 2, NULL, NULL, NULL, 'EMS', NULL, NULL, 1, '2026-02-28 19:19:41', 1, 1),
...
INSERT INTO `oei_episode_disposition` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `disposition_code`, `destination`, `decision_datetime`, `depart_datetime`, `admit_flag`, `notes`, `updated_by_user_id`, `updated_datetime`) VALUES
(1, 7, 5, NULL, 1, 'DISCHARGE', 'Home with ortho follow-up', '2026-02-28 22:12:11', NULL, 0, 'Grade II lateral ankle sprain. No fracture on Ottawa criteria. PRICE. Ibuprofen. Ortho f/u if not improving in 1 week. Return for increasing swelling, numbness, or instability.', 1, '2026-02-28 22:12:11'),
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Episode-linked document attachments';
...
INSERT INTO `oei_episode_event` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `event_type`, `event_datetime`, `user_id`, `note`) VALUES
(1, 1, 2, NULL, 1, 'ARRIVE', '2026-02-28 19:19:41', 1, 'EMS arrival — altered, febrile'),
...
INSERT INTO `oei_episode_location` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `location_id`, `location_code`, `start_datetime`, `end_datetime`, `user_id`, `note`) VALUES
(1, 1, 2, NULL, 1, 1, 'ED01', '2026-02-28 19:27:41', NULL, 1, 'Sepsis workup'),
...
INSERT INTO `oei_episode_status_history` (`id`, `episode_id`, `status_code`, `set_by_user_id`, `set_datetime`, `note`) VALUES
(1, 1, 'ARRIVE', 1, '2026-02-28 19:19:41', 'Arrived by EMS. Diaphoretic and confused.'),
...
INSERT INTO `oei_ereferral` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `referral_type`, `status`, `priority`, `destination_directory_id`, `destination_name`, `destination_fax`, `destination_phone`, `destination_address`, `reason_for_referral`, `clinical_summary`, `services_requested`, `medications_summary`, `followup_instructions`, `sent_datetime`, `sent_by_user_id`, `send_method`, `response_datetime`, `response_by_name`, `response_notes`, `created_by_user_id`, `created_datetime`, `updated_datetime`) VALUES
(1, 2, 3, NULL, 1, 'DISCHARGE', 'DRAFT', 'URGENT', 7, 'Mountain Cardiology Group', '(555) 730-8801', '(555) 730-8800', NULL, 'ACS rule-out complete. Three negative troponins. EKG without acute changes. Requesting cardiology follow-up and outpatient stress test.', 'Chest pain with TIMI score 3/7. Serial troponins x3 negative. No EKG changes. HTN, DM, hyperlipidemia. Stable for discharge.', 'Outpatient stress test within 72h; lipid panel; medication reconciliation', 'Aspirin 325 mg PO QD\nMetoprolol 25 mg PO BID\nHeparin 5000 units SQ Q8H (inpatient — discontinue at discharge)', 'Cardiology f/u within 72h. Return precautions for recurrent chest pain, SOB, syncope.', NULL, NULL, 'MANUAL', NULL, NULL, NULL, 1, '2026-02-28 21:19:41', '2026-02-28 21:19:41'),
(2, 5, 3, NULL, 1, 'DISCHARGE', 'DRAFT', 'URGENT', 7, 'Mountain Cardiology Group', '(555) 730-8801', '(555) 730-8800', NULL, 'ACS rule-out complete. Three negative troponins. EKG without acute changes. Requesting cardiology follow-up and outpatient stress test.', 'Chest pain with TIMI score 3/7. Serial troponins x3 negative. No EKG changes. HTN, DM, hyperlipidemia. Stable for discharge.', 'Outpatient stress test within 72h; lipid panel; medication reconciliation', 'Aspirin 325 mg PO QD\nMetoprolol 25 mg PO BID\nHeparin 5000 units SQ Q8H (inpatient — discontinue at discharge)', 'Cardiology f/u within 72h. Return precautions for recurrent chest pain, SOB, syncope.', NULL, NULL, 'MANUAL', NULL, NULL, NULL, 1, '2026-02-28 21:20:10', '2026-02-28 21:20:10'),
(3, 7, 5, NULL, 1, 'DISCHARGE', 'DRAFT', 'ROUTINE', 8, 'Orthopedic Associates of Riverside', '(555) 840-6601', '(555) 840-6600', NULL, 'Grade II lateral ankle sprain. Patient requires orthopedic follow-up within 1 week if not improving with conservative management.', 'Right ankle pain. X-ray: no fracture. Swelling lateral malleolus. Ottawa rules negative. PRICE initiated.', 'Orthopedic evaluation within 1 week; consider MRI if not improving', 'Ketorolac 30 mg IV (one dose, ED only)\nIbuprofen 600 mg PO Q6H x5 days', 'Weight bear as tolerated with crutches if needed. Ice 20 min Q2H. Elevate. Return if numbness, worsening swelling, inability to bear weight.', NULL, NULL, 'MANUAL', NULL, NULL, NULL, 1, '2026-02-28 22:15:11', '2026-02-28 22:15:11'),
(4, 10, 8, NULL, 1, 'DISCHARGE', 'SENT', 'ROUTINE', 6, 'Valley Home Health Agency', '(555) 620-5501', '(555) 620-5500', NULL, 'COPD exacerbation, stabilised. Requires home health for nebulizer management, medication education, and peak flow monitoring.', 'COPD (GOLD Stage III). Exacerbation treated with systemic steroids, antibiotics, and bronchodilators. SpO2 96% on 2L NC at discharge. Peak flow 62% predicted.', 'Home nebulizer setup and education; peak flow monitoring log; medication reconciliation; PCP notification', 'Albuterol 2.5 mg neb Q4H (wean to Q8H)\nIpratropium 0.5 mg neb Q6H\nPrednisone 40 mg PO QD x5 days\nAzithromycin 500 mg PO QD x5 days', 'PCP follow-up within 48h. Return for SpO2 < 90%, increased work of breathing, or altered mental status. Continue home oxygen if on it.', '2026-02-28 21:50:11', 1, 'FAX', NULL, NULL, NULL, 1, '2026-02-28 20:20:11', '2026-02-28 21:50:11'),
(5, 13, 11, NULL, 1, 'TRANSFER', 'ACCEPTED', 'URGENT', 3, 'Valley Behavioral Health Center', '(555) 340-7701', '(555) 340-7700', NULL, 'Voluntary psychiatric admission for major depressive disorder with passive suicidal ideation. No acute medical concerns. Stable for transfer.', 'Pt with MDD, no prior psych hospitalizations. Passive SI, no plan or intent. Columbia SSRS moderate risk. Fully cooperative. Medical clearance complete — normal CBC, BMP, UA, EKG.', 'Inpatient psychiatric stabilization; medication evaluation; individual and group therapy', 'No current psychiatric medications', 'Continue outpatient therapy after discharge. PCP follow-up within 1 week.', '2026-02-28 19:20:12', 1, '', '2026-02-28 20:50:12', 'Valley BH Intake Coordinator', 'Accepted — bed available unit 3B. Transport within 60 min.', 1, '2026-02-28 17:20:12', '2026-02-28 20:50:12'),
(6, 17, 53, NULL, 1, 'DISCHARGE', 'SENT', 'URGENT', NULL, 'Springfield Neurology Associates', '(555) 820-4401', '(555) 820-4400', '900 Medical Center Dr, Springfield IL 62701', 'Advanced Parkinson\'s disease — unwitnessed fall with laceration this morning. Requesting urgent neurology review for medication adjustment and fall prevention.', 'Harold Steinberg, 93M, Parkinson\'s Hoehn & Yahr Stage 3. Carbidopa/levodopa TID. Fall this morning beside bed — 2cm forearm laceration, hip bruising, X-ray pending. Fall count 1 this month vs baseline 2/month.', 'Urgent medication review: consider COMT inhibitor addition or dose timing adjustment. Gait and balance reassessment. PT recommendations.', 'Carbidopa/Levodopa 25/100mg TID (7AM, 12PM, 5PM); Rivastigmine patch 4.6mg/24h daily', 'Follow up within 5 business days. Return to AL with updated medication plan.', '2026-02-28 09:00:00', 1, 'FAX', NULL, NULL, NULL, 1, '2026-02-28 08:30:00', '2026-02-28 09:00:00'),
(7, 18, 54, NULL, 1, 'DISCHARGE', 'DRAFT', 'ROUTINE', NULL, 'Springfield Heart Center', '(555) 730-9901', '(555) 730-9900', '1200 Cardiology Blvd, Springfield IL 62701', 'CHF NYHA Class II — weight gain 2.8 lbs over 5 days. Requesting cardiology review of diuretic regimen.', 'Dorothy Vasquez, 79F, CHF NYHA Class II, T2DM HbA1c 9.2%. Daily weights: baseline 140.2 lbs, today 143.0 lbs (+2.8 lbs). Furosemide 20mg QAM. Note: medication error last week (40mg administered once, no adverse effects). FBG trending 140-180 on current insulin regimen.', 'Echocardiogram if not done within 6 months. Review diuretic dose. BMP with BNP.', 'Furosemide 20mg QAM; Lisinopril 10mg QD; Insulin glargine 18u QHS; Metformin 500mg BID', 'Cardiology note to AL facility within 3 business days. Repeat BMP in 1 week.', NULL, NULL, 'MANUAL', NULL, NULL, NULL, 1, '2026-02-28 10:00:00', '2026-02-28 10:00:00');
...
INSERT INTO `oei_facility_directory` (`id`, `facility_id`, `name`, `service_type`, `phone`, `fax`, `email`, `address`, `hours`, `notes`, `is_active`, `sort_order`) VALUES
(1, 1, 'Regional Trauma Center', 'TRAUMA', '(555) 900-1100', '(555) 900-1101', NULL, '1200 Trauma Pkwy, Riverside, CA 92501', '24/7', 'Level I Trauma Center. Direct accept line ext 4400.', 1, 10),
...
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='HL7 v2 ADT outbound message log';

--
-- Dumping data for table `oei_hl7_outbound_log`
--

INSERT INTO `oei_hl7_outbound_log` (`id`, `episode_id`, `pid`, `facility_id`, `event_type`, `transport_type`, `endpoint`, `message_body`, `ack_body`, `status`, `error_message`, `sent_datetime`) VALUES
(1, 4, 2, 1, 'A04', 'INTERNAL', 'INTERNAL', 'MSH|^~&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260315091500||ADT^A04^ADT_A01|OEI001|T|2.5.1\rEVN|A04|20260315091500\rPID|1||2^^^OEI^PI||Wilson^James||19670315|M\rPV1|1|E|ED01^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 19:20:12'),
(2, 5, 3, 1, 'A04', 'INTERNAL', 'INTERNAL', 'MSH|^~&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260315073000||ADT^A04^ADT_A01|OEI002|T|2.5.1\rEVN|A04|20260315073000\rPID|1||3^^^OEI^PI||Chen^Margaret||19570822|F\rPV1|1|O|OBS1^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 00:20:12'),
(3, 5, 3, 1, 'A01', 'INTERNAL', 'INTERNAL', 'MSH|^~&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260315073000||ADT^A01^ADT_A01|OEI003|T|2.5.1\rEVN|A01|20260315093000\rPID|1||3^^^OEI^PI||Chen^Margaret||19570822|F\rPV1|1|O|OBS1^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 02:20:12'),
(4, 8, 6, 1, 'A04', 'INTERNAL', 'INTERNAL', 'MSH|^~&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260315113500||ADT^A04^ADT_A01|OEI004|T|2.5.1\rEVN|A04|20260315113500\rPID|1||6^^^OEI^PI||Patel^Robert||19520108|M\rPV1|1|E|TR01^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 21:55:12'),
(5, 9, 7, 1, 'A04', 'INTERNAL', 'INTERNAL', 'MSH|^~&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260315100000||ADT^A04^ADT_A01|OEI005|T|2.5.1\rEVN|A04|20260315100000\rPID|1||7^^^OEI^PI||Torres^Linda||19790719|F\rPV1|1|E|TR02^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 20:20:12'),
(6, 9, 7, 1, 'A08', 'INTERNAL', 'INTERNAL', 'MSH|^~&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260315103000||ADT^A08^ADT_A01|OEI006|T|2.5.1\rEVN|A08|20260315103000\rPID|1||7^^^OEI^PI||Torres^Linda||19790719|F\rPV1|1|E|TR02^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 20:50:12'),
(7, 10, 8, 1, 'A01', 'INTERNAL', 'INTERNAL', 'MSH|^~&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260315031500||ADT^A01^ADT_A01|OEI007|T|2.5.1\rEVN|A01|20260315031500\rPID|1||8^^^OEI^PI||Kim^David||19630425|M\rPV1|1|O|OBS2^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 11:20:12'),
(8, 4, 2, 1, 'A02', 'MLLP', 'hl7.hospital.internal:2575', 'MSH|^~\\&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260228192513||ADT^A02^ADT_A01|OEI010|T|2.5.1\rEVN|A02|20260228192513\rPID|1||2^^^OEI^PI||Wilson^James||19670315|M\rPV1|1|E|ED01^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 19:25:13'),
(9, 5, 3, 1, 'A01', 'MLLP', 'hl7.hospital.internal:2575', 'MSH|^~\\&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260228022013||ADT^A01^ADT_A01|OEI011|T|2.5.1\rEVN|A01|20260228022013\rPID|1||3^^^OEI^PI||Chen^Margaret||19570822|F\rPV1|1|O|OBS1^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 02:20:13'),
(10, 8, 6, 1, 'A02', 'MLLP', 'hl7.hospital.internal:2575', 'MSH|^~\\&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260228215713||ADT^A02^ADT_A01|OEI012|T|2.5.1\rEVN|A02|20260228215713\rPID|1||6^^^OEI^PI||Patel^Robert||19520108|M\rPV1|1|E|TR01^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 21:57:13'),
(11, 9, 7, 1, 'A03', 'HTTP', 'https://rtc.hospital.org/hl7/adt', 'MSH|^~\\&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260228220513||ADT^A03^ADT_A01|OEI013|T|2.5.1\rEVN|A03|20260228220513\rPID|1||7^^^OEI^PI||Torres^Linda||19790719|F\rPV1|1|E|TR02^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 22:05:13'),
(12, 0, 0, 1, 'A09', 'MLLP', 'hl7.hospital.internal:2575', 'MSH|^~\\&|OE-INSTITUTIONAL|OPENEMR|EMS-DISPATCH|REGIONAL|20260228202013||ADT^A09^ADT_A01|OEI014|T|2.5.1\rEVN|A09|20260228202013\rZDV|TRAUMA|DIVERSION|Mass casualty incident — redirect to Regional Trauma Center', NULL, 'SENT', NULL, '2026-02-28 20:20:13'),
(13, 12, 10, 1, 'A08', 'MLLP', 'hl7.hospital.internal:2575', 'MSH|^~\\&|OE-INSTITUTIONAL|OPENEMR|RECEIVING|FACILITY|20260228215013||ADT^A08^ADT_A01|OEI015|T|2.5.1\rEVN|A08|20260228215013\rPID|1||10^^^OEI^PI||Williams^Marcus||19960318|M\rPV1|1|E|ED04^^^OPENEMR', NULL, 'SENT', NULL, '2026-02-28 21:50:13'),
(14, 6, 4, 1, 'A04', 'MLLP', 'hl7-backup.hospital.internal:2576', 'MSH|^~\\&|OE-INSTITUTIONAL|OPENEMR|BACKUP|FACILITY|20260228172213||ADT^A04^ADT_A01|OEI016|T|2.5.1\rEVN|A04|20260228172213\rPID|1||4^^^OEI^PI||Brooks^Tyler||19900511|M\rPV1|1|E|PSY1^^^OPENEMR', NULL, 'NACK', NULL, '2026-02-28 17:22:13');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='AL incident reports; mandatory_report_sent tracks state notification status';

--
-- Dumping data for table `oei_incident`
--

INSERT INTO `oei_incident` (`id`, `episode_id`, `facility_id`, `reported_by_user_id`, `incident_type`, `severity`, `incident_datetime`, `location_description`, `narrative`, `corrective_action`, `reported_state`, `mandatory_report_sent`, `created_datetime`) VALUES
(1, 17, 1, 1, 'FALL_INJURY', 'HIGH', '2026-02-28 17:20:13', 'Wing B Room 201 - beside bed', 'Resident found on floor beside bed during AM care check. Unwitnessed. Alert and oriented x2 on assessment. No LOC. 2cm laceration right forearm, mild bruising right hip. No signs of hip fracture. X-ray ordered. Physician and family notified.', 'Assisted resident to bed. Wound cleaned and dressed. Neuro checks q1h x4h. Bed in lowest position, floor mat placed. Fall alarm re-evaluated. PT to reassess ambulation safety. Care plan goal updated.', 'PENDING', 0, '2026-02-28 17:50:13'),
(2, 18, 1, 1, 'MED_ERROR', 'MODERATE', '2026-02-19 20:20:13', 'Wing B Room 205 - medication cart', 'Resident received furosemide 40mg instead of scheduled 20mg due to look-alike packaging. Error discovered during next-shift MAR review. No acute adverse effects. BP 118/72, HR 74, SpO2 97%. Electrolytes ordered and within normal limits.', 'Physician notified immediately. Electrolyte panel ordered. Resident monitored q2h x8h. Pharmacy notified. Root cause: look-alike packaging. Corrective action: separate storage, barcode scan protocol initiated.', 'NOT_REQUIRED', 0, '2026-02-19 21:20:13');
...
INSERT INTO `oei_location` (`id`, `facility_id`, `code`, `name`, `location_type`, `status`, `unit_name`, `is_active`, `sort_order`, `notes`) VALUES
(1, 1, 'ED01', 'ED Room 1', 'ROOM', 'AVAILABLE', 'ED', 1, 10, 'Standard ED room'),
...
INSERT INTO `oei_mar_administration` (`id`, `mar_order_id`, `episode_id`, `pid`, `facility_id`, `scheduled_datetime`, `administered_datetime`, `outcome`, `dose_given`, `unit_given`, `route_given`, `site`, `lot_number`, `hold_reason`, `administered_by_user_id`, `note`, `is_high_alert`, `created_datetime`, `updated_datetime`) VALUES
(1, 0, 1, 2, 1, '2026-02-28 19:36:41', '2026-02-28 19:39:41', 'GIVEN', '1500', 'mg', 'IV', NULL, NULL, NULL, 1, 'First dose — infused over 90 min', 1, '2026-02-28 19:36:41', '2026-02-28 19:39:41'),
...
(21, 25, 10, 8, 1, '2026-02-28 18:20:13', '2026-02-28 18:21:13', 'GIVEN', '2.5', 'mg', 'INH', NULL, NULL, NULL, 1, '[Amended 2026-02-27 07:15:00 by user 1] Original entry: HELD/NPO in error — patient tolerating PO. Corrected to GIVEN after review of physician orders.', 0, '2026-02-28 18:20:13', '2026-02-28 18:20:13'),
(22, 32, 14, 50, 1, '2026-02-27 21:00:00', '2026-02-27 21:05:00', 'GIVEN', '10', 'mg', 'PO', NULL, NULL, NULL, 1, 'Administered with evening water. Resident cooperative.', 0, '2026-02-27 21:05:00', '2026-02-27 21:05:00'),
(23, 32, 14, 50, 1, '2026-02-28 21:00:00', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2026-02-28 06:00:00', '2026-02-28 06:00:00'),
(24, 40, 17, 53, 1, '2026-02-28 07:00:00', '2026-02-28 07:12:00', 'GIVEN', '25/100', 'mg', 'PO', NULL, NULL, NULL, 1, 'Within 30-min window. Resident in off-period pre-dose; good response observed 45 min post.', 0, '2026-02-28 07:12:00', '2026-02-28 07:12:00'),
(25, 40, 17, 53, 1, '2026-02-28 12:00:00', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2026-02-28 06:00:00', '2026-02-28 06:00:00'),
(26, 40, 17, 53, 1, '2026-02-28 17:00:00', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2026-02-28 06:00:00', '2026-02-28 06:00:00'),
(27, 42, 18, 54, 1, '2026-02-27 08:00:00', '2026-02-27 08:05:00', 'GIVEN', '20', 'mg', 'PO', NULL, NULL, NULL, 1, 'Correct 20mg dose verified by barcode. Weight pre-dose 143.0 lbs.', 0, '2026-02-27 08:05:00', '2026-02-27 08:05:00'),
(28, 42, 18, 54, 1, '2026-02-28 08:00:00', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Verify 20mg dose — double check after yesterday med error', 0, '2026-02-28 06:00:00', '2026-02-28 06:00:00'),
(29, 44, 18, 54, 1, '2026-02-27 21:00:00', '2026-02-27 21:08:00', 'GIVEN', '18', 'units', 'SQ', 'Abdomen R', NULL, NULL, 1, 'FBG 162 at HS. Base dose 18u. No sliding scale addition needed.', 0, '2026-02-27 21:08:00', '2026-02-27 21:08:00'),
(30, 44, 18, 54, 1, '2026-02-28 21:00:00', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '2026-02-28 06:00:00', '2026-02-28 06:00:00'),
(31, 38, 16, 52, 1, '2026-02-28 08:00:00', '2026-02-28 08:10:00', 'GIVEN', '18', 'mcg', 'Inh', NULL, NULL, NULL, 1, 'HandiHaler administered. Technique confirmed. SpO2 95% post-dose.', 0, '2026-02-28 08:10:00', '2026-02-28 08:10:00');
...
INSERT INTO `oei_mar_order` (`id`, `episode_id`, `pid`, `facility_id`, `drug_name`, `dose`, `unit`, `route`, `frequency`, `is_prn`, `status`, `ordered_datetime`, `discontinued_datetime`, `ordered_by_user_id`, `discontinued_by_user_id`, `rx_id`, `instructions`, `created_datetime`, `updated_datetime`) VALUES
(1, 1, 2, 1, 'Vancomycin', '1500', 'mg', 'IV', 'Q8H', 0, 'ACTIVE', '2026-02-28 19:34:41', NULL, 1, NULL, NULL, 'Infuse over 90 min. Monitor troughs. Sepsis dosing.', '2026-02-28 19:34:41', '2026-02-28 19:34:41'),
...
(30, 12, 10, 1, 'Naloxone', '0.4', 'mg/hr', 'IV', 'CONTINUOUS', 0, 'ACTIVE', '2026-02-28 20:58:12', NULL, 1, NULL, NULL, 'Start 0.4mg/hr. Titrate for RR > 12. HIGH ALERT — monitor q15min. Max 2mg/hr. Wean when clinically appropriate.', '2026-02-28 20:58:12', '2026-02-28 20:58:12'),
...
INSERT INTO `oei_obs_plan` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `protocol_key`, `status`, `start_datetime`, `target_hours`, `runway_hours`, `protocol_json`, `updated_by_user_id`, `updated_datetime`) VALUES
(1, 2, 3, NULL, 1, 'CHEST_PAIN', 'ACTIVE', '2026-02-28 02:19:41', 24, 4, '{\"protocol_key\":\"CHEST_PAIN\",\"label\":\"Chest Pain / ACS Rule-Out\",\"target_hours\":24,\"runway_hours\":4}', 1, '2026-02-28 02:19:41'),
...
INSERT INTO `oei_protocol` (`id`, `facility_id`, `protocol_key`, `label`, `version`, `enabled`, `definition_json`, `updated_by_user_id`, `updated_datetime`) VALUES
(1, 1, 'CHEST_PAIN', 'Chest Pain / ACS Rule-Out', '2.1', 1, '{\"protocol_key\":\"CHEST_PAIN\",\"label\":\"Chest Pain / ACS Rule-Out\",\"target_hours\":24,\"runway_hours\":4,\"tasks\":[{\"type\":\"EKG\",\"at_minutes\":[0,360],\"label\":\"12-Lead EKG\"},{\"type\":\"TROPONIN\",\"at_minutes\":[0,360,720],\"label\":\"Serial Troponin\"},{\"type\":\"VITALS_CHECK\",\"every_minutes\":240,\"label\":\"Vitals Q4H\"},{\"type\":\"DISPOSITION_DECISION\",\"at_minutes\":1320,\"label\":\"Cardiology consult or discharge decision\"}]}', 1, '2026-02-28 22:20:10'),
(2, 1, 'COPD_EXACERBATION', 'COPD Exacerbation Observation', '1.3', 1, '{\"protocol_key\":\"COPD_EXACERBATION\",\"label\":\"COPD Exacerbation Observation\",\"target_hours\":24,\"runway_hours\":6,\"tasks\":[{\"type\":\"SPIROMETRY\",\"at_minutes\":[0,360,720],\"label\":\"Peak Flow / Spirometry\"},{\"type\":\"ABG\",\"at_minutes\":[60],\"label\":\"Arterial Blood Gas\"},{\"type\":\"VITALS_CHECK\",\"every_minutes\":120,\"label\":\"Vitals Q2H\"},{\"type\":\"NEBS\",\"every_minutes\":240,\"label\":\"Albuterol Neb Treatment\"},{\"type\":\"DISPOSITION_DECISION\",\"at_minutes\":1080,\"label\":\"Admit vs discharge decision\"}]}', 1, '2026-02-28 22:20:10'),
(3, 1, 'SEPSIS_BUNDLE', 'Sepsis 3-Hour Bundle', '3.0', 1, '{\"protocol_key\":\"SEPSIS_BUNDLE\",\"label\":\"Sepsis 3-Hour Bundle\",\"target_hours\":3,\"runway_hours\":0.5,\"tasks\":[{\"type\":\"BLOOD_CULTURE\",\"at_minutes\":[0],\"label\":\"Blood Cultures x2\"},{\"type\":\"LACTATE\",\"at_minutes\":[0],\"label\":\"Serum Lactate\"},{\"type\":\"IV_FLUID\",\"at_minutes\":[0],\"label\":\"30mL/kg IV Fluid Bolus\"},{\"type\":\"ANTIBIOTICS\",\"at_minutes\":[0],\"label\":\"Broad-Spectrum Antibiotics\"},{\"type\":\"VITALS_CHECK\",\"every_minutes\":60,\"label\":\"Vitals Q1H\"}]}', 1, '2026-02-28 22:20:10'),
(4, 1, 'STROKE_ALERT', 'Code Stroke Protocol', '2.5', 1, '{\"protocol_key\":\"STROKE_ALERT\",\"label\":\"Code Stroke Protocol\",\"target_hours\":1,\"runway_hours\":0.25,\"tasks\":[{\"type\":\"CT_HEAD_STAT\",\"at_minutes\":[0],\"label\":\"Non-contrast CT Head STAT\"},{\"type\":\"CT_ANGIO\",\"at_minutes\":[15],\"label\":\"CTA Head & Neck\"},{\"type\":\"NIHSS_SCORE\",\"at_minutes\":[0],\"label\":\"NIHSS Assessment\"},{\"type\":\"NEUROLOGY_CONSULT\",\"at_minutes\":[0],\"label\":\"Neurology Consult\"},{\"type\":\"IV_ACCESS\",\"at_minutes\":[0],\"label\":\"Two large-bore IVs\"},{\"type\":\"LABS_STAT\",\"at_minutes\":[0],\"label\":\"Coags / CBC / BMP STAT\"},{\"type\":\"TPA_DECISION\",\"at_minutes\":[30],\"label\":\"tPA Eligibility Assessment\"}]}', 1, '2026-02-28 22:20:10'),
(5, 1, 'OPIOID_OVERDOSE', 'Opioid Overdose / Naloxone Protocol', '1.1', 1, '{\"protocol_key\":\"OPIOID_OVERDOSE\",\"label\":\"Opioid Overdose Protocol\",\"target_hours\":4,\"runway_hours\":1,\"tasks\":[{\"type\":\"VITALS_CHECK\",\"every_minutes\":30,\"label\":\"Vitals Q30min (watch re-sedation)\"},{\"type\":\"NALOXONE_TITRATE\",\"at_minutes\":[0],\"label\":\"Naloxone Drip Titration\"},{\"type\":\"BH_CONSULT\",\"at_minutes\":[60],\"label\":\"Behavioral Health Consult\"},{\"type\":\"NARCAN_EDUCATION\",\"at_minutes\":[180],\"label\":\"Narcan Rx and education if discharge\"}]}', 1, '2026-02-28 22:20:10'),
(6, 1, 'PEDIATRIC_FEVER', 'Pediatric Fever Protocol (< 13y)', '1.0', 1, '{\"protocol_key\":\"PEDIATRIC_FEVER\",\"label\":\"Pediatric Fever Protocol\",\"target_hours\":4,\"runway_hours\":0.5,\"tasks\":[{\"type\":\"TEMP_RECHECK\",\"at_minutes\":[60],\"label\":\"Temperature Recheck\"},{\"type\":\"UA_RESULT\",\"at_minutes\":[30],\"label\":\"UA / Culture Review\"},{\"type\":\"CBC_REVIEW\",\"at_minutes\":[45],\"label\":\"CBC with Differential\"},{\"type\":\"ANTIPYRETIC\",\"at_minutes\":[0],\"label\":\"Acetaminophen or Ibuprofen\"}]}', 1, '2026-02-28 22:20:10'),
...
INSERT INTO `oei_schema_version` (`version`, `applied_datetime`) VALUES
('1.0.0-demo', '2026-02-28 22:20:12');
...
INSERT INTO `oei_settings` (`id`, `facility_id`, `setting_key`, `setting_value`, `updated_by_user_id`, `updated_datetime`) VALUES
(1, 1, 'facility_name', 'Community Memorial Hospital ED', 1, '2026-02-28 22:20:10'),
...
INSERT INTO `oei_task` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `task_type`, `due_datetime`, `completed_datetime`, `assigned_to_user_id`, `status`, `payload_json`, `created_by_user_id`, `created_datetime`) VALUES
(1, 1, 2, NULL, 1, 'BLOOD_CULTURE', '2026-02-28 20:49:41', NULL, NULL, 'OPEN', '{\"priority\":\"STAT\",\"note\":\"2 sets before antibiotics — OVERDUE\"}', 1, '2026-02-28 19:27:41'),
...
(71, 15, 51, NULL, 1, 'PAIN_ASSESSMENT', '2026-03-01 00:57:27', NULL, 1, 'OPEN', '{\"note\":\"Post-PT pain score — NRS target 3 or below; document opioid taper progress\"}', 1, '2026-02-28 06:00:00'),
...
(73, 16, 52, NULL, 1, 'VITALS_CHECK', '2026-03-01 00:57:27', NULL, 1, 'OPEN', '{\"note\":\"Morning vitals — SpO2 target above 92% RA; document inhaler adherence\"}', 1, '2026-02-10 22:45:00'),
...
(76, 17, 53, NULL, 1, 'XRAY_FOLLOWUP', '2026-03-01 02:57:27', NULL, 1, 'OPEN', '{\"note\":\"Review X-ray results — right forearm and hip; PT clearance for ambulation\"}', 1, '2026-02-28 06:30:00'),
...
INSERT INTO `oei_transfer` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `transfer_type`, `reason`, `receiving_directory_id`, `receiving_name`, `requested_datetime`, `accepted_datetime`, `transport_datetime`, `status`, `checklist_json`, `notes`, `updated_by_user_id`, `updated_datetime`) VALUES
(1, 9, 7, NULL, 1, 'TRANSFER', 'Grade III splenic laceration requiring surgical intervention', NULL, 'Regional Trauma Center', '2026-02-28 21:20:11', '2026-02-28 21:50:11', NULL, 'ACCEPTED', '{\"items\":[{\"label\":\"Accepting physician identified\",\"done\":true},{\"label\":\"Report given to receiving team\",\"done\":true},{\"label\":\"Transfer consent signed\",\"done\":true},{\"label\":\"Records copied\",\"done\":true},{\"label\":\"Transport unit confirmed\",\"done\":true},{\"label\":\"Stable for transport\",\"done\":true}]}', 'Dr. Reyes at RTC accepted directly. MTP ongoing — Hgb 7.8. 2u pRBC transfused. Transport ETA 15 min.', 1, '2026-02-28 22:05:11');
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Triage vitals sets; multiple per episode for re-triage support';

--
-- Dumping data for table `oei_triage`
--

INSERT INTO `oei_triage` (`id`, `episode_id`, `pid`, `eid`, `facility_id`, `set_number`, `bp_systolic`, `bp_diastolic`, `hr`, `rr`, `temp_f`, `spo2`, `gcs`, `pain_score`, `weight_kg`, `arrival_mode`, `esi_suggested`, `notes`, `noted_by_user_id`, `noted_datetime`) VALUES
(1, 1, 2, NULL, 1, 1, 88, 58, 122, 26, 102.40, 92, 12, 5, 82.00, 'EMS', 2, 'Patient confused, combative on arrival. Diaphoretic. Warm, mottled extremities. Family reports 3-day productive cough, chills, progressive confusion. qSOFA: RR 26, GCS < 15, SBP 88. Sepsis bundle initiated.', 1, '2026-02-28 19:24:41'),
...
(4, 4, 2, NULL, 1, 1, 88, 58, 122, 26, 102.40, 92, 12, 5, 82.00, 'EMS', 2, 'Patient confused, combative on arrival. Diaphoretic. Warm, mottled extremities. Family reports 3-day productive cough, chills, progressive confusion. qSOFA: RR 26, GCS < 15, SBP 88. Sepsis bundle initiated.', 1, '2026-02-28 19:25:10'),
...
(7, 6, 4, NULL, 1, 1, 128, 80, 90, 14, 98.30, 99, 15, 0, NULL, 'POLICE', 3, 'Calm and cooperative. Reports SI — \"I have a plan and the means.\" Denies HI. Last EtOH 8h prior. Chronic depression, hx of one prior attempt 2yo. No acute medical complaints. Patient consented to evaluation.', 1, '2026-02-28 17:21:10'),
...
(9, 8, 6, NULL, 1, 1, 192, 108, 86, 18, 98.80, 96, 13, 0, 89.00, 'EMS', 1, 'Sudden onset left arm and leg weakness with facial droop and dysarthria. Last known well 0930 — 90 min ago. AF on EKG strip by EMS. BP 192/108. GCS 13. Right gaze deviation. Witnessed by wife.', 1, '2026-02-28 21:57:11'),
...
(13, 11, 9, NULL, 1, 1, 96, 60, 118, 22, 103.80, 99, 15, 4, 23.00, 'WALKIN', 3, 'Age 7. Fever 103.8°F, onset 24h ago. Dysuria and increased frequency x 2d. Mild suprapubic tenderness. No CVA tenderness. No vomiting. Tolerating PO. Alert and interactive. PMH: none. No allergies.', 1, '2026-02-28 21:38:11'),
(14, 12, 10, NULL, 1, 1, 108, 68, 96, 10, 97.60, 91, 6, 0, 78.00, 'EMS', 2, 'Found unresponsive bathroom. EMS: pinpoint pupils, shallow respirations RR 6, O2 sat 84%. Narcan 0.4mg IM x2 — GCS improved to 14. Denies substance use when awake. Paraphernalia found at scene.', 1, '2026-02-28 20:52:12'),
(15, 13, 11, NULL, 1, 1, 118, 74, 82, 14, 98.20, 100, 15, 0, NULL, 'WALKIN', 3, 'Voluntary presentation. Reports passive SI — \"I don\'t want to be here anymore\" — but no plan or intent. Depression x 6 months, recently lost job. No psych history, no substances. Calm, cooperative, insightful. Family supportive and present.', 1, '2026-02-28 14:21:12');
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Per-user care context preference per facility';

--
-- Dumping data for table `oei_user_context`
--

INSERT INTO `oei_user_context` (`id`, `user_id`, `facility_id`, `context_key`, `updated_datetime`) VALUES
(1, 1, 1, 'ED_ACUTE', '2026-02-28 22:20:10'),
