...
<head>
  ...
  <style>
    ...
    .handoff-table th { background: #e9ecef; font-size: .75rem;
    ...
    .esi-1 { background: #842029; color: #fff; }
    .esi-2 { background: #dc3545; color: #fff; }
    .esi-3 { background: #ffc107; color: #000; }
    .esi-4 { background: #198754; color: #fff; }
    .esi-5 { background: #0dcaf0; color: #000; }

    .task-overdue { color: #dc3545; font-weight: 600; }
    .mar-pending  { color: #856404; font-weight: 600; }

    .sep-row { background: #f0f4ff; font-size: .7rem;
    ...
    <table class="table table-bordered table-sm handoff-table align-middle">
      <thead>
        <tr>
          ...
          <th style="width:50px;"><?= xlt('ESI') ?></th>
          ...
          <tr class="<?= $rowClass ?>">
            ...
            <td class="text-center">
              <?php if (!empty($r['acuity_esi'])): ?>
                <span class="badge esi-<?= (int)$r['acuity_esi'] ?>"><?= (int)$r['acuity_esi'] ?></span>
              <?php else: ?>
